...
// static void writeCharOnRam(int frameNum,int offset,sim_database_t* sim_db,char value,int pageNum);
...
// void printPageTable(sim_database_t *sim_db);
// void printSwapFile(sim_database_t* sim_db);
